...
class GradingAgent(Agent):
    ...
    def getAction(self, state):
        ...
        if not curRightStatesExplored and self.wrongStatesExplored < 0:
            self.wrongStatesExplored = 1
            print "- Wrong number of states explored:", studentAction[1], "correct number of states explored:", zip(*optimalActions)[1]
        ...
        if not studentOptimalAction:
            ...
            print "- Sub-optimal action selected:", studentAction[0], "optimal actions:", zip(*optimalActions)[0]
        self.stepCount += 1
